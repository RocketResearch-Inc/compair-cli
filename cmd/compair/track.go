...
var trackCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = registerRepoDocument(client, groupID, remote, root, repoRegistrationOptions{
			...
			InitialNoFeedback: trackNoFeedback,
...
func init() {
	...
	trackCmd.Flags().BoolVar(&trackNoFeedback, "no-feedback", false, "When used with --initial-sync, upload the baseline without generating feedback")
